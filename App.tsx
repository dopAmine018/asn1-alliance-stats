                ...
                >
                    <div className="absolute top-4 right-4 z-20">
                        {settings.allow_storm_registration ? (
                            <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[8px] font-bold uppercase tracking-widest animate-pulse">
                                <span className="w-1 h-1 bg-emerald-500 rounded-full"></span>
                                Applying Open
                            </span>
                        ) : (
                            <span className="px-2 py-1 rounded bg-slate-800 border border-slate-700 text-slate-500 text-[8px] font-bold uppercase tracking-widest">
                                Finalized
                            </span>
                        )}
                    </div>
