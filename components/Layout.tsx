      ...
      <footer className="mt-20 border-t border-white/5 bg-[#010409] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col items-center gap-6 relative z-10">
            ...
            <div className="group relative">
                <div className="absolute -inset-2 bg-gradient-to-r from-sky-500/0 via-sky-500/10 to-sky-500/0 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                <p className="text-[10px] text-slate-500 font-mono tracking-[0.2em] border border-slate-800/50 bg-slate-900/30 px-4 py-2 rounded-full group-hover:border-sky-500/30 group-hover:text-sky-500 transition-colors cursor-default">
                    {t('credit.architect')}
                </p>
            </div>
