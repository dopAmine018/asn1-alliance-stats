  ...
  <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="flex flex-col items-center space-y-8">
            ...
            <div className="flex items-center gap-6 px-6 py-2 rounded-full border border-white/10 bg-slate-900/40 backdrop-blur-md shadow-2xl">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-widest">Active Status: <span className="text-white">101</span></span>
                </div>
                <div className="w-[1px] h-3 bg-white/10"></div>
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-sky-500 shadow-[0_0_8px_#0ea5e9]"></div>
                    <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-widest">Total Power: <span className="text-white">2.56B</span></span>
                </div>
            </div>
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-400 font-header font-bold text-xs md:text-sm tracking-[0.4em] uppercase opacity-80">
                    Central Intelligence & Logistics Terminal
                </p>
            </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl px-4">
          ...
          >
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-header font-black text-white uppercase tracking-tight group-hover:text-sky-400 transition-colors">Update Stats</h3>
                        <p className="text-[10px] text-slate-500 mt-2 font-mono uppercase tracking-[0.2em] leading-relaxed">Submit latest stats to HQ</p>
                    </div>
                </div>
          </button>
          ...
          >
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-header font-black text-white uppercase tracking-tight group-hover:text-emerald-400 transition-colors">Leaderboard</h3>
                        <p className="text-[10px] text-slate-500 mt-2 font-mono uppercase tracking-[0.2em] leading-relaxed">View global alliance rankings</p>
                    </div>
                </div>
          </button>
          ...
          >
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-header font-black text-white uppercase tracking-tight group-hover:text-purple-400 transition-colors">Desert Storm</h3>
                        <p className="text-[10px] text-slate-500 mt-2 font-mono uppercase tracking-[0.2em] leading-relaxed">Weekly team roster</p>
                    </div>
                </div>
          </button>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-6">
          <button onClick={() => onView('train')} className="group flex items-center gap-3 px-8 py-4 bg-slate-900/50 border border-white/5 rounded-2xl hover:border-sky-500/30 transition-all">
              <span className="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em] transition-colors">Train Schedule</span>
