...
const translations: Record<Language, Record<TranslationKey, string>> = {
  english: {
    ...
    'section.infrastructure': '04 // Infrastructure',
  ...
  arabic: {
    ...
    'section.infrastructure': '04 // البنية التحتية',
    ...
    'viewer.leaderboard': 'سجل التحالف',
    'viewer.search': 'بحث عن عميل...',
    'viewer.sort': 'معيار الفرز',
    'viewer.showing': 'نشط',
    'viewer.no_results': 'لم يتم العثور على عملاء.',
  ...
  turkish: {
    ...
    'section.infrastructure': '04 // Altyapı',
  ...
  indonesian: {
    ...
    'section.infrastructure': '04 // Infrastruktur',
    ...
    'viewer.leaderboard': 'Daftar Aliansi',
    'viewer.search': 'Cari operatif...',
    'viewer.sort': 'Parameter Sortir',
    'viewer.showing': 'aktif',
    'viewer.no_results': 'Operatif tidak ditemukan.',
